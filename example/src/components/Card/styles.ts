...
export const createCardStyles = (props: StyledCardProps) => {
  ...
  return css`
    ...
    background-color: ${typeof variantStyles['backgroundColor'] === 'string'
      ...
      : 'transparent'};
    border: ${typeof variantStyles['border'] === 'string'
      ? variantStyles['border']
      : 'none'};

    /* 边框半径 */
    border-radius: ${getBorderRadiusStyles(
    ...
    /* 过渡动画 */
    transition: all ${defaultTheme.animations.duration.normal} ${defaultTheme
