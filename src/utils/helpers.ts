import { CardSize, CardVariant, ShadowLevel, BorderRadius, ThemeConfig } from '../types';
 ...
 * 获取阴影级别对应的样式
 */
export const getShadowStyles = (shadow: ShadowLevel, theme: ThemeConfig = defaultTheme): string => {
...
export const getContrastTextColor = (
  ...
  const isLight = backgroundColor.includes('#fff') || backgroundColor.includes('white');
