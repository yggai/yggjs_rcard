...
export const useCardInteraction = (props: UseCardInteractionProps): UseCardInteractionReturn => {
  const { onClick, onMouseEnter, onMouseLeave, disabled = false, clickable = false } = props;
